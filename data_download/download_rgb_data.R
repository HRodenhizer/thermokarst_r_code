...
### User Input ############################################################################################
# choose your data type - currently: high-resolution orthorectified camera imagery mosaic level 1 data
data_type <- 'DP3.30010.001'
# choose your site - currently: Healy
site <- 'HEAL'
# choose year - currently: 2018
year <- '2018'
...
download_filepath <- paste('Z:/Schuur Lab/2020 New_Shared_Files/DATA/Remote Sensing/NEON/Airborne_Data_', year, '/RGB/', sep = '')
# this is the filepath to the individual DTM files once they have been downloaded
dtm_filepath <- paste(download_filepath, data_type, '/', year, '/FullSite/D', as.character(as.numeric(year)-2000), '/', year, '_HEAL_', as.character(as.numeric(year)-2016),'/L3/DiscreteLidar/DTMGtif/', sep = '')
# this is the filepath to the individual DSM files once they have been downloaded
# this will need updating
dsm_filepath <- paste(download_filepath, data_type, '/', year, '/FullSite/D', as.character(as.numeric(year)-2000), '/', year, '_HEAL_', as.character(as.numeric(year)-2016),'/L3/DiscreteLidar/DSMGtif/', sep = '')
